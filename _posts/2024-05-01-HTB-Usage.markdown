...
![nmap results](/assets/images/Usage/nmap%20results.png)
...
![nmap results](/assets/images/Usage/dir%20results%20base.png)
![nmap results](/assets/images/Usage/dirb%20results%20admin.png)
...
![nmap results](/assets/images/Usage/landing%20page.png)

echo "10.10.11.18 admin.usage.htb" | sudo tee -a /etc/hosts
tail /etc/hosts

![nmap results](/assets/images/Usage/admin%20portal.png)
...
![nmap results](/assets/images/Usage/inspect%20results.png)
![nmap results](/assets/images/Usage/inspect%20cookie%20results.png)
...
![nmap results](/assets/images/Usage/blog%20posts.png)
...
And got 3 databases:
![nmap results](/assets/images/Usage/sqlmap%20results.png)
![nmap results](/assets/images/Usage/sqlmap%20db%20type.png)
...
![nmap results](/assets/images/Usage/slqmap%20tables.png)
![nmap results](/assets/images/Usage/sqlmap%20hash.png)
...
![nmap results](/assets/images/Usage/hashcat%20output.png)
...
![nmap results](/assets/images/Usage/admin%20uploaddd%20pic.png)
...
![nmap results](/assets/images/Usage/php-html%20shell%20pic.png)
...
![nmap results](/assets/images/Usage/reverse%20shell.png)
...
![nmap results](/assets/images/Usage/db%20pass.png)
...
![nmap results](/assets/images/Usage/sudo%20usage_management.png)
...
![nmap results](/assets/images/Usage/strings.png)
...
![nmap results](/assets/images/Usage/ssh%20key.png)
...
![nmap results](/assets/images/Usage/root.png)
...
![nmap results](/assets/images/Usage/no%20options.png)
...
![nmap results](/assets/images/Usage/cleanup.png)